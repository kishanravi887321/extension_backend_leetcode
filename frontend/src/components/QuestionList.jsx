          ...
          >
            <div className="row-main">
              ...
              <div className="col-actions">
                <button 
                  className={`action-btn notes ${question.notes ? 'has-notes' : ''} ${selectedQuestionId === question._id ? 'active' : ''}`}
                  onClick={(e) => {
                    e.stopPropagation();
                    onRowClick && onRowClick(selectedQuestionId === question._id ? null : question);
                  }}
                  title={question.notes ? 'View notes' : 'No notes'}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill={question.notes ? "currentColor" : "none"} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
